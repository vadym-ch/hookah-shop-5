...
public final class TobakkoServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.example.grpc.server.grpcserver.tobakko.GetRequest,
      com.example.grpc.server.grpcserver.tobakko.GetResponse> METHOD_GET =
      io.grpc.MethodDescriptor.<com.example.grpc.server.grpcserver.tobakko.GetRequest, com.example.grpc.server.grpcserver.tobakko.GetResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "com.example.grpc.server.grpcserver.tobakko.TobakkoService", "get"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.example.grpc.server.grpcserver.tobakko.GetRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.example.grpc.server.grpcserver.tobakko.GetResponse.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.example.grpc.server.grpcserver.tobakko.DeleteRequest,
      com.example.grpc.server.grpcserver.tobakko.DeleteResponse> METHOD_DELETE =
      io.grpc.MethodDescriptor.<com.example.grpc.server.grpcserver.tobakko.DeleteRequest, com.example.grpc.server.grpcserver.tobakko.DeleteResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "com.example.grpc.server.grpcserver.tobakko.TobakkoService", "delete"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.example.grpc.server.grpcserver.tobakko.DeleteRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.example.grpc.server.grpcserver.tobakko.DeleteResponse.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.example.grpc.server.grpcserver.tobakko.CreateRequest,
      com.example.grpc.server.grpcserver.tobakko.CreateResponse> METHOD_CREATE =
      io.grpc.MethodDescriptor.<com.example.grpc.server.grpcserver.tobakko.CreateRequest, com.example.grpc.server.grpcserver.tobakko.CreateResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "com.example.grpc.server.grpcserver.tobakko.TobakkoService", "create"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.example.grpc.server.grpcserver.tobakko.CreateRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.example.grpc.server.grpcserver.tobakko.CreateResponse.getDefaultInstance()))
          .build();
   ...
   */
  public static TobakkoServiceBlockingStub newBlockingStub(
   ...
   */
  public static TobakkoServiceFutureStub newFutureStub(
      io.grpc.Channel channel) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.example.grpc.server.grpcserver.tobakko.GetRequest,
                com.example.grpc.server.grpcserver.tobakko.GetResponse>(
                  this, METHODID_GET)))
          .addMethod(
            METHOD_DELETE,
            asyncUnaryCall(
              new MethodHandlers<
                com.example.grpc.server.grpcserver.tobakko.DeleteRequest,
                com.example.grpc.server.grpcserver.tobakko.DeleteResponse>(
                  this, METHODID_DELETE)))
          .addMethod(
            METHOD_CREATE,
            asyncUnaryCall(
              new MethodHandlers<
                com.example.grpc.server.grpcserver.tobakko.CreateRequest,
                com.example.grpc.server.grpcserver.tobakko.CreateResponse>(
  ...
  public static final class TobakkoServiceStub extends io.grpc.stub.AbstractStub<TobakkoServiceStub> {
    ...
    @java.lang.Override
    protected TobakkoServiceStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  public static final class TobakkoServiceBlockingStub extends io.grpc.stub.AbstractStub<TobakkoServiceBlockingStub> {
    ...
    @java.lang.Override
    protected TobakkoServiceBlockingStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
    ...
    /**
     */
    public com.example.grpc.server.grpcserver.tobakko.GetResponse get(com.example.grpc.server.grpcserver.tobakko.GetRequest request) {
    ...
    /**
     */
    public com.example.grpc.server.grpcserver.tobakko.DeleteResponse delete(com.example.grpc.server.grpcserver.tobakko.DeleteRequest request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public com.example.grpc.server.grpcserver.tobakko.CreateResponse create(com.example.grpc.server.grpcserver.tobakko.CreateRequest request) {
      return blockingUnaryCall(
  ...
  public static final class TobakkoServiceFutureStub extends io.grpc.stub.AbstractStub<TobakkoServiceFutureStub> {
    ...
    @java.lang.Override
    protected TobakkoServiceFutureStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
      ...
      synchronized (TobakkoServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new TobakkoServiceDescriptorSupplier())
