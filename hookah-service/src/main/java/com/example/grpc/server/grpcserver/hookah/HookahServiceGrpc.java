...
/**
 */
@javax.annotation.Generated(value = "by gRPC proto compiler (version 1.4.0)", comments = "Source: Hookah.proto")
public final class HookahServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.example.grpc.server.grpcserver.hookah.GetRequest, com.example.grpc.server.grpcserver.hookah.GetResponse> METHOD_GET = io.grpc.MethodDescriptor.<com.example.grpc.server.grpcserver.hookah.GetRequest, com.example.grpc.server.grpcserver.hookah.GetResponse>newBuilder()
      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
      .setFullMethodName(generateFullMethodName("com.example.grpc.server.grpcserver.hookah.HookahService", "get"))
      .setRequestMarshaller(io.grpc.protobuf.ProtoUtils
          .marshaller(com.example.grpc.server.grpcserver.hookah.GetRequest.getDefaultInstance()))
      .setResponseMarshaller(io.grpc.protobuf.ProtoUtils
          .marshaller(com.example.grpc.server.grpcserver.hookah.GetResponse.getDefaultInstance()))
      .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.example.grpc.server.grpcserver.hookah.DeleteRequest, com.example.grpc.server.grpcserver.hookah.DeleteResponse> METHOD_DELETE = io.grpc.MethodDescriptor.<com.example.grpc.server.grpcserver.hookah.DeleteRequest, com.example.grpc.server.grpcserver.hookah.DeleteResponse>newBuilder()
      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
      .setFullMethodName(generateFullMethodName("com.example.grpc.server.grpcserver.hookah.HookahService", "delete"))
      .setRequestMarshaller(io.grpc.protobuf.ProtoUtils
          .marshaller(com.example.grpc.server.grpcserver.hookah.DeleteRequest.getDefaultInstance()))
      .setResponseMarshaller(io.grpc.protobuf.ProtoUtils
          .marshaller(com.example.grpc.server.grpcserver.hookah.DeleteResponse.getDefaultInstance()))
      .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.example.grpc.server.grpcserver.hookah.CreateRequest, com.example.grpc.server.grpcserver.hookah.CreateResponse> METHOD_CREATE = io.grpc.MethodDescriptor.<com.example.grpc.server.grpcserver.hookah.CreateRequest, com.example.grpc.server.grpcserver.hookah.CreateResponse>newBuilder()
      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
      .setFullMethodName(generateFullMethodName("com.example.grpc.server.grpcserver.hookah.HookahService", "create"))
      .setRequestMarshaller(io.grpc.protobuf.ProtoUtils
          .marshaller(com.example.grpc.server.grpcserver.hookah.CreateRequest.getDefaultInstance()))
      .setResponseMarshaller(io.grpc.protobuf.ProtoUtils
          .marshaller(com.example.grpc.server.grpcserver.hookah.CreateResponse.getDefaultInstance()))
      .build();
   ...
   */
  public static HookahServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
   ...
   * service
   */
  public static HookahServiceFutureStub newFutureStub(io.grpc.Channel channel) {
  ...
  public static abstract class HookahServiceImplBase implements io.grpc.BindableService {
    ...
    public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(METHOD_GET, asyncUnaryCall(
          new MethodHandlers<com.example.grpc.server.grpcserver.hookah.GetRequest, com.example.grpc.server.grpcserver.hookah.GetResponse>(
              this, METHODID_GET)))
          .addMethod(METHOD_DELETE, asyncUnaryCall(
              new MethodHandlers<com.example.grpc.server.grpcserver.hookah.DeleteRequest, com.example.grpc.server.grpcserver.hookah.DeleteResponse>(
                  this, METHODID_DELETE)))
          .addMethod(METHOD_CREATE, asyncUnaryCall(
              new MethodHandlers<com.example.grpc.server.grpcserver.hookah.CreateRequest, com.example.grpc.server.grpcserver.hookah.CreateResponse>(
  ...
  public static final class HookahServiceStub extends io.grpc.stub.AbstractStub<HookahServiceStub> {
    ...
    private HookahServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected HookahServiceStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static final class HookahServiceBlockingStub extends io.grpc.stub.AbstractStub<HookahServiceBlockingStub> {
    ...
    private HookahServiceBlockingStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected HookahServiceBlockingStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new HookahServiceBlockingStub(channel, callOptions);
    }

    /**
     */
    public com.example.grpc.server.grpcserver.hookah.GetResponse get(
    ...
    /**
     */
    public com.example.grpc.server.grpcserver.hookah.DeleteResponse delete(
    ...
    /**
     */
    public com.example.grpc.server.grpcserver.hookah.CreateResponse create(
  ...
  public static final class HookahServiceFutureStub extends io.grpc.stub.AbstractStub<HookahServiceFutureStub> {
    ...
    private HookahServiceFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected HookahServiceFutureStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      ...
      synchronized (HookahServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new HookahServiceDescriptorSupplier()).addMethod(METHOD_GET).addMethod(METHOD_DELETE)
              .addMethod(METHOD_CREATE).build();
        }
      }
    }
    return result;
